...
interface PaginatedDataOptions<T> {
    /** API获取函数 */
    fetchFn: (params: FilterParams) => Promise<ApiResponse<{ items?: T[], [key: string]: any, pagination?: any }>>;
    /** 每页条目数 */
    itemsPerPage?: number;
...
export function usePaginatedData<T>({
    ...
    // 加载数据
    const loadData = useCallback(async (page: number = state.currentPage, currentFilters: FilterParams = filters) => {
