    ...
    return mockJobs.filter(job => {
      ...
      if (selectedSalaryRange !== 'all') {
        ...
        if (hourlyMatch) {
          ...
          if (selectedSalaryRange === 'medium' && (avgHourly < 15 || avgHourly > 25)) return false;
      ...
      <section className="w-full py-2">
        ...
        <div className="space-y-2 mb-4">
          <Select 
            ...
            onSelectionChange={(keys) => handleFilterChange('jobType', Array.from(keys)[0] as string)}
            className="w-full"
            size="sm"
          >
          ...
          <Select 
            ...
            onSelectionChange={(keys) => handleFilterChange('workTime', Array.from(keys)[0] as string)}
            className="w-full"
            size="sm"
          >
          ...
          <Select 
            ...
            onSelectionChange={(keys) => handleFilterChange('salaryRange', Array.from(keys)[0] as string)}
            className="w-full"
            size="sm"
          >
        ...
        <div className="flex items-center justify-between mb-3">
          <p className="text-sm text-default-600">
            共找到 <span className="font-semibold text-primary">{filteredJobs.length}</span> 个职位
          </p>
