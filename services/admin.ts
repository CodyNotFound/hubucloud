...
class AdminService {
     ...
     * 检查管理员权限
     */
    async checkAdminRole(): Promise<{ status: string; data?: AdminCheckResponse; message?: string }> {
     ...
     * 获取管理员统计数据
     */
    async getAdminStats(): Promise<{ status: string; data?: { stats: AdminStats }; message?: string }> {
     ...
     * 提升用户为管理员
     */
    async promoteUser(targetUserId: string): Promise<{ status: string; data?: any; message?: string }> {
     ...
     * 撤销用户的管理员权限
     */
    async demoteAdmin(targetUserId: string): Promise<{ status: string; data?: any; message?: string }> {
     ...
     * 更新兼职信息（管理员）
     */
    async updateParttime(id: string, data: {
        name?: string;
        type?: string;
        salary?: string;
        time?: string;
